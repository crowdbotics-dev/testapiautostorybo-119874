...
## Project Structure
    ...
    ├── testapiautostorybo_119874  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_119874`
...
2. Clone this repo and `cd testapiautostorybo_119874`
